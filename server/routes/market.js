...
const POPULAR_TICKERS = [
  ...
  { symbol: 'JUP-USD', name: 'Jupiter USD' },
  { symbol: 'BONK-USD', name: 'Bonk USD' },
  { symbol: 'WIF-USD', name: 'dogwifhat USD' },
  { symbol: 'PYTH-USD', name: 'Pyth Network USD' },
  { symbol: 'RNDR-USD', name: 'Render Token USD' },
  { symbol: 'HNT-USD', name: 'Helium USD' },
  { symbol: 'JTO-USD', name: 'Jito USD' },
